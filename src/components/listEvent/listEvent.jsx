...
const ListEvent = () => {
  ...
  const saveResponsability = async () => {
    try {
      const response = await fetch(`http://localhost:8007/api/event-has-responsability/event/${selectedEvent.value}/specific-responsability`, {
        method: 'POST',
        headers: {
    ...
    <>
      <div className="listEvent-container">
        ...
        <div className="listEvents-container">
          <div className="list-top flex flex-col">
            ...
            <div className="main-form">
              <form onSubmit={handleForm}>
                <div className='form-section event-section'>
                  <span className='section-title'>Datos de la Responsabilidad Especifica</span>
                  <div className="row">
                    <div className="form-box">
                      <label htmlFor="responsability_name">Nombre de la responsabilidad Especifica</label>
                    ...
                    <div className="form-box">
                      <label htmlFor="responsability_descriptión">Descripción de la responsabilidad Especifica</label>
